    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-green-300 py-3 px-8 rounded-xl outline-none w-fit text-black font-bold shadow-md shadow-primary'
          >
	      ...
	      <button
            ...
            onClick={() => window.open("https://drive.google.com/file/d/15zZlzJXqb2EeFigJBcaU-RNVM-fJlVpp/view?usp=sharing", "_blank")}
          >
